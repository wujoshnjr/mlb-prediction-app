...
def generate_predictions(elo_system=None):
    ...
    if not odds_df.empty:
        ...
        if not odds_dict:
            errors.append("赔率字典为空，请检查 odds 队名映射")
    else:
    ...
    if filter_value_bets:
        try:
            ...
            errors.append(f"Value bets 失败: {e}")
