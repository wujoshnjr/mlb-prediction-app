...
def generate_report() -> dict[str, Any]:
    ...
    checks: dict[str, Any] = {
        ...
        "computed_hash_matches_declared_hash": (
            get_model_feature_schema_hash() == MODEL_FEATURE_SCHEMA_HASH
        ),
        "train_ensemble_file_exists": TRAIN_ENSEMBLE_PATH.exists(),
        "prediction_file_exists": PREDICTION_PATH.exists(),
        "train_ensemble_references_core": file_contains(
            TRAIN_ENSEMBLE_PATH,
            "CORE_MODEL_FEATURES",
        ),
        "prediction_references_core": file_contains(
            PREDICTION_PATH,
            "CORE_MODEL_FEATURES",
        ),
        "train_ensemble_references_training_samples": file_contains(
            TRAIN_ENSEMBLE_PATH,
