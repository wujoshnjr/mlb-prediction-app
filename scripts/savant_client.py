...
def fetch_savant_statcast(date_str: str = None, errors: list = None) -> pd.DataFrame:
    if not date_str:
        ...
        start_str = date_str
        end_str = date_str
    url = ("https://baseballsavant.mlb.com/statcast_search/csv?all=true&hfPT=&hfAB=&hfBBT=&hfPR=&hfZ=&stadium=&hfBBL=&hfNewZones="
    ...
    try:
        ...
        desired = ['pitch_type','release_speed','events','game_date','launch_speed','launch_angle','barrel','hard_hit',
                   'hit_distance_sc','expected_batting_avg','expected_slugging_percent','expected_woba','pitch_hand','bat_side']
