...
def init_database():
    ...
    cursor.execute("""
        CREATE TABLE IF NOT EXISTS predictions (
            ...
            sp_era_diff REAL,
            sp_fip_diff REAL,
            bullpen_ip_diff REAL,
            rest_diff REAL,
            park_factor REAL,
            dynamic_park_factor REAL,
            platoon_ops_diff REAL,
            statcast_launch_speed_diff REAL,
            statcast_barrel_diff REAL,
            statcast_hard_hit_diff REAL,
            statcast_woba_diff REAL,
            timezone_diff REAL,
            is_day_game INTEGER,
            home_back2back INTEGER,
            away_back2back INTEGER,
            catcher_era_diff REAL,
            cs_diff REAL,
            wind_effect REAL,
            temp_effect REAL,
            precip_effect REAL,
            ...
            pythag_diff REAL,
            log5_prob REAL,
            lag30_winrate_diff REAL,
            lag30_runs_diff REAL,
            pitch_movement_diff REAL,
            k_pct_diff REAL,
            bb_pct_diff REAL,
            avg_bat_speed_diff REAL,
            pitcher_rating_diff REAL,
            odds_change REAL,
            zone_size REAL,
            k_rate REAL,
            bullpen_availability_diff REAL,
            elo_momentum_7d REAL,
            elo_momentum_30d REAL,
            barrel_pa_diff REAL,
            hardhit_pa_diff REAL,
            closing_odds REAL,
            top_features TEXT,
            market_divergence INTEGER,
            odds_source TEXT,
...
def insert_prediction(data: dict):
    ...
    columns = [
        ...
        "pred_uncertainty","kelly_fraction","home_win","elo_diff","market_prob",
        ...
        "injury_diff","pythag_diff","log5_prob","lag30_winrate_diff","lag30_runs_diff",
        ...
        "barrel_pa_diff","hardhit_pa_diff","closing_odds","top_features",
        "market_divergence","odds_source"
    ]
